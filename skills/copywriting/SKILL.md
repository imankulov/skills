...
name: copywriting
description: |
  Natural copywriting guidelines that detect and avoid AI-generated text patterns.
  Use when writing website content, marketing copy, email templates, support
  communications, landing pages, changelogs, or any user-facing text for a software
  product. Also use when reviewing copy for AI tells or editing drafts to sound human.
  Do NOT use for: agent instructions (AGENTS.md, SKILL.md, CLAUDE.md), or other files
  primarily read by AI agents.
---

# Natural Copywriting Guidelines

These guidelines ensure copy sounds human and authentic. Based on documented patterns
of AI-generated text (see
...
3. **Sound like a person wrote it.** Read your copy aloud. If it sounds like a press
   release, rewrite it.
